...
class TrickFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function initTrick($trick, $trickData): Trick
    {
        ...
        $authorsData = $this->getReference('user' . mt_rand(1, UserFixtures::DATA));
        $categoriesData = $this->getReference('category' . mt_rand(0, count(CategoryFixtures::CATEGORY_DATA) - 1));
